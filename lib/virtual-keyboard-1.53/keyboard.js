...
(function() {
  ...
  this.VKI_flashPassword = 0; // 1000; // Flash last character of password: 0 = disabled, > 0 = delay in ms
  this.VKI_imageURI = 'keyboard.svg'; // 'keyboard.svg';  If empty string, use imageless mode
  ...
  VKI_attach = function(elem) {
    ...
    if (self.VKI_imageURI) {
      let keybut = document.createElement('img');
          ...
          keybut.src = 'https://pasmangen-extension.github.io/lib/virtual-keyboard-1.53/keyboard.svg'
